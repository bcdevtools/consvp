...
func Execute() {
	...
	rootCmd.Flags().StringP(flagMockStreamingServer, "t", "mock", "for testing purpose only, mock a streaming server or connect to local streaming server to test the streaming client.")
